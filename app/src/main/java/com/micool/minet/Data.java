...
public class Data {
    ...
    public Data(float[] mag, double tesla, float[] orientation, String id, String direction) {
        this.x = mag[0];
        this.y = mag[1];
        this.z = mag[2];
        this.tesla = tesla;
    ...
    public Data(float x, float y, float z, float azimuth, float pitch, float roll, double tesla, String id, String direction) {
        this.x = x;
        this.y = y;
        this.z = z;
